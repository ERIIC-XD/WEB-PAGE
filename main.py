...
<body>
  <header class="header mt-4">
    <h1 class="mt-3">𝗢𝗡𝗪𝗘𝗥[♥︎__________𝗘𝗥𝗜𝗜𝗖 𝗧𝗥𝗜𝗖𝗞𝗘𝗥</h1>
  </header>
  ...
  <footer class="footer">
    ...
    <p><a href="https://chat.whatsapp.com/ELLVRskIk9X0uDUhWnGp2L">Chat on Messenger</a></p>
    <div class="mb-3">
      <a href="https://wa.link/b7w4cp" class="whatsapp-link">
